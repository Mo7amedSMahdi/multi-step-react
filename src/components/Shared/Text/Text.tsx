...
const getStyleLevelClasses = (level: StyleAs | AsElement) => STYLE_LEVEL_TO_CLASSES[level as StyleAs] ?? STYLE_LEVEL_TO_CLASSES.p;
...
export const Text = <T extends AsElement>({
  as, styleAs, className = '', children, role, ...rest
}: TextProps<T>) => {
